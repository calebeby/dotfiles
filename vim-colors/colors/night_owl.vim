...
hi Cursor guifg=#011627 guibg=#abb2bf
hi CursorLine guibg=#1d3b53 gui=none
hi NonText guifg=#637777
...
hi TabLine guifg=#637777 guibg=#011627 gui=none
...
hi Search guifg=#1d3b53 guibg=#ef5350
hi Comment guifg=#637777 gui=italic
hi String guifg=#addb67
hi Statement guifg=#c792ea gui=none
hi Type guifg=#ef5350 gui=none
...
hi PreProc guifg=#ef5350
hi Function guifg=#82aaff
hi xmlTag guifg=#abb2bf
hi xmlEndTag guifg=#abb2bf
hi xmlTagName guifg=#abb2bf
hi xmlTagN guifg=#abb2bf
hi xmlAttrib guifg=#82aaff
hi SpellBad gui=undercurl guisp=#abb2bf
hi SpellLocal gui=undercurl guisp=#f78c6c
