...
hi Cursor guifg=#1d2021 guibg=#d5c4a1
hi CursorLine guibg=#3c3836 gui=none
...
hi TabLine guifg=#665c54 guibg=#1d2021 gui=none
...
hi DiffAdd guibg=#434622 gui=none
hi DiffChange guibg=#1d2021
hi DiffDelete guifg=#3e2623 guibg=#3e2623 gui=none
hi DiffText guibg=#434622 gui=none
hi DiffAdded guifg=#b8bb26 guibg=#1d2021
hi DiffFile guifg=#fb4934 guibg=#1d2021
hi DiffNewFile guifg=#b8bb26 guibg=#1d2021
hi DiffLine guifg=#83a598 guibg=#1d2021
hi DiffRemoved guifg=#fb4934 guibg=#1d2021
hi SignifySignAdd guifg=#bdae93 guibg=#434622
hi SignifySignChange guifg=#bdae93 guibg=#36413e
hi SignifySignDelete guifg=#bdae93 guibg=#542a25
